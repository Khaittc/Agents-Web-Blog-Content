...
**Version**: 1.1  
**Mã tài liệu**: `IMAGE_SPECIFICATION_AND_PROMPT_SKILL_v1.1`  
**Trạng thái**: Áp dụng chính thức cho toàn bộ Visual Agent, Drafting Agent và Tech Review Agent  
**Ngày ban hành**: 23/09/2026  
**Thay thế**: `IMAGE_PROMPT_STYLE_GUIDE_v1.0.md` (Đã lưu trữ tại `00_SKILL/archive/`)  
...
<div style="margin:28px 0;text-align:center;">
    <img src="[URL_HINH_ANH_[STT]]" alt="[MÔ_TẢ_ALT_CHUẨN_KỸ_THUẬT_SEO]" style="max-width:100%;height:auto;border-radius:4px;box-shadow:0 2px 8px rgba(0,0,0,0.08);border:1px solid #e2e8f0;" />
